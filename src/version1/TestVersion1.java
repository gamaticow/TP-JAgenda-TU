...
public class TestVersion1 {
    ...
    public void testAddRdvSameCalendar(){
        ...
        Assertions.assertThrows(IllegalArgumentException.class,  () -> rdvm.addRendezvous(rdv));
    }
    ...
    @Test
    @Order(10)
    public void testUpdateRdvOnExistingCalendar(){
        Rendezvous rdv = new RendezvousImpl("RDV4", "Quatrième rendez-vous", getDate(16, 30), 90);
        rdv = rdvm.addRendezvous(rdv);
        rdv.setTime(getDate(17, 0));
        Rendezvous finalRdv = rdv;
        Assertions.assertThrows(IllegalArgumentException.class, () -> rdvm.updateRendezvous(finalRdv));
    }

    @Test
    @Order(11)
    public void testGetRdvBetween(){
        Assertions.assertEquals(2, rdvm.getRendezvousBetween(getDate(10, 0), getDate(12, 0)).size());
    }

    @Test
    @Order(12)
    public void testGetRdvBefore(){
        Assertions.assertEquals(1, rdvm.getRendezvousBefore(getDate(11, 0)).size());
    }
    ...
    public void testGetRdvToday(){
        ...
        Assertions.assertEquals(4, rdvm.getRendezvousToday().size());
    }
    ...
    public void testHasOverlap(){
        ...
        Assertions.assertFalse(rdvm.hasOverlap(getDate(8, 0), getDate(12, 0)));
    }
